...
local color_groups = {
   ...
   NormalFloat =                   {guifg=C.textdark, guibg=C.neardark2, gui="none"},
   ...
   DiagnosticSignError =           {guifg=C.red6,     guibg=C.neardark2, gui="none"},
   DiagnosticSignHint =            {guifg=C.orange2,  guibg=C.neardark2, gui="none"},
   DiagnosticSignInfo =            {guifg=C.br_blue,  guibg=C.neardark2, gui="none"},
   DiagnosticSignWarn =            {guifg=C.yellow5,  guibg=C.neardark2, gui="none"},
